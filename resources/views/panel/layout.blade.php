...
<aside :class="sidebarMobile ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
  ...
  <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-px scrollbar-thin">
    ...
    {!! $renderItem(
      ...
      'Pencarian Cepat ⌘K', 'panel.search'
    ) !!}
    ...
    {!! $renderItem(
      ...
      'Multi-Properti', 'panel.multi-property'
    ) !!}
    @endif

    @if($isFO)
    {{-- ═══ 2. 🛎️ Front Office & F&B ═══ --}}
    {!! $cluster('🛎️ Front Office & F&B') !!}
    ...
    <div x-data="{ open: {{ $foOpen ? 'true' : 'true' }} }" class="space-y-px">
      ...
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        ...
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>', 'Micro-stay',        'panel.microstay.index') !!}
        ...
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>', 'Kiosk Check-in',   'panel.kiosk.sessions') !!}
        ...
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18 10H6m12 2a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4a2 2 0 012-2zM12 14v.01M15 14v.01M9 14v.01M6 10V7a3 3 0 013-3h6a3 3 0 013 3v3"/></svg>', 'Fleet & Shuttle',  'panel.fo.fleet.dashboard') !!}
      </div>
    </div>
    ...
    <div x-data="{ open: {{ $hkOpen ? 'true' : 'false' }} }" class="space-y-px">
      ...
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        ...
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0zM2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>', 'Kamar (Status)',    'panel.hk.rooms') !!}
    ...
    <div x-data="{ open: {{ $invOpen ? 'true' : 'false' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
        ...
        <span class="flex-1 text-left">Inventaris & Procurement</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
    ...
    @php $spOpen = $groupActive(['panel.spa','panel.banquet','panel.kids-club']); @endphp
    <div x-data="{ open: {{ $spOpen ? 'true' : 'false' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
        ...
        <span class="flex-1 text-left">Fasilitas Tambahan</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>', 'Kids Club',         'panel.kids-club.index') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>', 'Spa — Ikhtisar',   'panel.spa.index') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>', 'Spa — Janji',       'panel.spa.appointments') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.701 2.701 0 00-1.5-.454M9 6v2m3-2v2m3-2v2M9 3h.01M12 3h.01M15 3h.01M21 21v-7a2 2 0 00-2-2H5a2 2 0 00-2 2v7h18zm-3-9v-2a2 2 0 00-2-2H8a2 2 0 00-2 2v2h12z"/></svg>', 'Banquet — Ikhtisar','panel.banquet.index') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>', 'Banquet — Acara',   'panel.banquet.events.index') !!}
      </div>
    </div>
    @endif
    @endif

    @if($isFO || $isFinance || $isAdmin)
    {{-- ═══ 4. 💰 Keuangan & Akuntansi ═══ --}}
    {!! $cluster('💰 Keuangan & Akuntansi') !!}
    ...
    <div x-data="{ open: {{ $acOpen ? 'true' : 'false' }} }" class="space-y-px">
      ...
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066"/></svg>', 'Ikhtisar',          'panel.accounting.dashboard') !!}
    ...
    <div x-data="{ open: {{ $fnOpen ? 'true' : 'false' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
        ...
        <span class="flex-1 text-left">Treasury</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
    ...
    @php $owOpen = $groupActive(['panel.finance']); @endphp
    <div x-data="{ open: {{ $owOpen ? 'true' : 'false' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
              class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-[13px] font-medium {{ $owOpen ? 'text-white' : 'text-white/65 hover:bg-white/5 hover:text-white' }} transition-colors">
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
        <span class="flex-1 text-left">Owner Relations</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
    ...
    <div x-data="{ open: {{ $hrOpen ? 'true' : 'false' }} }" class="space-y-px">
      ...
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>', 'Ikhtisar',          'panel.hr.index') !!}
    ...
    @if($isFO || $isRevenue || $isAdmin)
    {{-- ═══ 6. 📈 Revenue Management ═══ --}}
    {!! $cluster('📈 Revenue Management') !!}

    @php $prOpen = $groupActive(['panel.pricing']); @endphp
    <div x-data="{ open: {{ $prOpen ? 'true' : 'true' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
        ...
        <span class="flex-1 text-left">Pricing</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        ...
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>', 'Paket & Bundle',    'panel.packages.index') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066"/></svg>', 'Dynamic Packages', 'panel.packages.builder') !!}
      </div>
    </div>

    @php $rmOpen = $groupActive(['panel.rms']); @endphp
    <div x-data="{ open: {{ $rmOpen ? 'true' : 'true' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
              class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-[13px] font-medium {{ $rmOpen ? 'text-white' : 'text-white/65 hover:bg-white/5 hover:text-white' }} transition-colors">
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
        <span class="flex-1 text-left">Forecasting & Yield</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"/></svg>', 'Ikhtisar RMS',      'panel.rms.dashboard') !!}
        ...
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>', 'Intelijen Kompetitor', 'panel.rms.competitor-intelligence') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>', 'Rate Shopper',      'panel.rms.rate-shopper') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>', 'Rate Scraper',      'panel.rms.scraper.index') !!}
    ...
    @php $rvOpen = $groupActive(['panel.revenue','panel.upsell']); @endphp
    ...
    @if($isFO || $isRevenue || $isAdmin)
    {{-- ═══ 7. 🌐 Distribusi & Channel Manager ═══ --}}
    {!! $cluster('🌐 Distribusi & Channel Manager') !!}
    ...
    <div x-data="{ open: {{ $chOpen ? 'true' : 'true' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
        ...
        <span class="flex-1 text-left">Channel Manager</span>
        <span class="text-[9px] font-bold bg-rose-500/90 text-white px-1.5 py-0.5 rounded">OTA</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
    ...
    @php $slOpen = $groupActive(['panel.sales','panel.channel']); @endphp
    <div x-data="{ open: {{ $slOpen ? 'true' : 'false' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
              class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-[13px] font-medium {{ $slOpen ? 'text-white' : 'text-white/65 hover:bg-white/5 hover:text-white' }} transition-colors">
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
        <span class="flex-1 text-left">Sales & Group Business</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064"/></svg>', 'GDS Booking',       'panel.channel.gds') !!}
    ...
    @if($isFO || $isMarketing || $isAdmin)
    {{-- ═══ 8. 📢 Pemasaran & Tamu ═══ --}}
    {!! $cluster('📢 Pemasaran & Tamu') !!}

    @php $guOpen = $groupActive(['panel.guests','panel.rfm','panel.guests']); @endphp
    <div x-data="{ open: {{ $guOpen ? 'true' : 'true' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
              class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-[13px] font-medium {{ $guOpen ? 'text-white' : 'text-white/65 hover:bg-white/5 hover:text-white' }} transition-colors">
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
        <span class="flex-1 text-left">Guest Management</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>', 'Tamu',              'panel.guests.index') !!}
        ...
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>', 'RFM Segmentation',  'panel.rfm.index') !!}
      </div>
    </div>

    @php $loyOpen = $groupActive(['panel.loyalty']); @endphp
    <div x-data="{ open: {{ $loyOpen ? 'true' : 'false' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
        ...
        <span class="flex-1 text-left">Loyalitas</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
    ...
    @php $coOpen = $groupActive(['panel.comm','panel.messages']); @endphp
    <div x-data="{ open: {{ $coOpen ? 'true' : 'true' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
        ...
        <span class="flex-1 text-left">Komunikasi & Campaign</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        ...
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>', 'Guest Messaging',   'panel.messages.index') !!}
    ...
    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>', 'Blog', 'panel.blog.index') !!}

    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>', 'Agregator Ulasan',  'panel.marketing.review-aggregator') !!}
    ...
    <div x-data="{ open: {{ $cgOpen ? 'true' : 'false' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
        ...
        <span class="flex-1 text-left">Konsierge & Survei</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
    ...
    @if($isSistem)
    {{-- ═══ 10. ⚙️ Sistem & Tata Kelola ═══ --}}
    {!! $cluster('⚙️ Sistem & Tata Kelola') !!}

    @php $syOpen = $groupActive(['panel.settings','panel.audit']); @endphp
    <div x-data="{ open: {{ $syOpen ? 'true' : 'false' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
        ...
        <span class="flex-1 text-left">Pengaturan Properti</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>', 'Properti',          'panel.settings.property') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3c-1.1 0-2 .9-2 2v1H7a2 2 0 00-2 2v2a2 2 0 002 2h10a2 2 0 002-2V8a2 2 0 00-2-2h-3V5c0-1.1-.9-2-2-2zM5 14h3v4H5v-4zm5 0h4v4h-4v-4zm6 0h3v4h-3v-4z"/></svg>', 'Tipe Kamar',        'panel.settings.room-types.index') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 21v-4a1 1 0 011-1h4a1 1 0 011 1v4M3 21h18M3 21H1m20 0h-2M10 7V3m0 4H7m3 0h3m-3 7v4m0-4H7m3 0h3m6-3V3m0 4h-3m3 0h3m-3 7v4m0-4h-3m3 0h3M7 10h10v4H7v-4z"/></svg>', 'Kamar',             'panel.settings.rooms.index') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z"/></svg>', 'Pajak',             'panel.settings.tax') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/></svg>', 'Kebijakan Pembatalan','panel.settings.cancellation-policies') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>', 'Template Dokumen',  'panel.settings.doc-templates') !!}
      </div>
    </div>

    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>', 'Pengguna & Peran', 'panel.settings.users') !!}

    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>', 'Manajemen Role',   'panel.settings.roles.index') !!}

    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>', 'Keamanan 2FA',     'panel.settings.two-factor') !!}

    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>', 'Log Audit',        'panel.audit.index') !!}

    @php $cpOpen = $groupActive(['panel.compliance','panel.security']); @endphp
    <div x-data="{ open: {{ $cpOpen ? 'true' : 'false' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
              class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-[13px] font-medium {{ $cpOpen ? 'text-white' : 'text-white/65 hover:bg-white/5 hover:text-white' }} transition-colors">
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4M5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 018.618 3.04A12.02 12.02 0 0121 9c0 5.591-3.824 10.29-9 11.622-5.176-1.332-9-6.03-9-11.622 0-1.042.133-2.052.382-3.016z"/></svg>
        <span class="flex-1 text-left">Kepatuhan & Keamanan</span>
        <svg class="nav-chevron w-3.5 h-3.5 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div x-show="open" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-px">
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>', 'Izin & Lisensi',   'panel.compliance.licenses.index') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>', 'Privasi Data',     'panel.compliance.privacy.index') !!}
        {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>', 'Insiden',          'panel.security.incidents.index') !!}
      </div>
    </div>

    @php $aiOpen = $groupActive(['panel.ai']); @endphp
    <div x-data="{ open: {{ $aiOpen ? 'true' : 'false' }} }" class="space-y-px">
      <button @click="open=!open" :aria-expanded="open ? 'true' : 'false'"
        ...
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
        <span class="flex-1 text-left">AI & Automation Config</span>
    ...
    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>', 'Payment Gateway',  'panel.settings.payments.index') !!}

    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/></svg>', 'Smart Locks',      'panel.settings.locks.index') !!}

    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/></svg>', 'Printer Thermal',  'panel.settings.printer') !!}

    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z"/></svg>', 'Integrasi (SMS/WA/Email)', 'panel.settings.integrations') !!}
    ...
    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/></svg>', 'Keberlanjutan',    'panel.sustainability.dashboard') !!}

    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>', 'Lisensi Aplikasi',  'panel.settings.license') !!}

    {!! $renderItem('<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>', 'Basis Pengetahuan', 'panel.kb.index') !!}
    @endif
